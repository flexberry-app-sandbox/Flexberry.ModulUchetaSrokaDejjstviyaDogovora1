...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta sroka dejjstviya dogovora расчет ост врем l');

test('testing i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-расчет-ост-врем-l', function(assert) {
