...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta sroka dejjstviya dogovora клиент l');

test('testing i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-клиент-l', function(assert) {
