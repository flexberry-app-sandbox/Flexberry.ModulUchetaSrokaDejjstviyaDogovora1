...
moduleForAcceptance('[AGAT] Acceptance | i i s modul ucheta sroka dejjstviya dogovora дир отд по раб с кл l');

test('testing i-i-s-modul-ucheta-sroka-dejjstviya-dogovora-дир-отд-по-раб-с-кл-l', function(assert) {
