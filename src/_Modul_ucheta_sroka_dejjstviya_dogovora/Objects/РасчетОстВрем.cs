...
namespace IIS._Modul_ucheta_sroka_dejjstviya_dogovora
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS._Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг fОказУслуг;
        ...
        public virtual IIS._Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг ОказУслуг
        {
            get
            {
                ...
                {
                    this.fОказУслуг = new IIS._Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг(this);
                }
                IIS._Modul_ucheta_sroka_dejjstviya_dogovora.DetailArrayOfОказУслуг result = this.fОказУслуг;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS._Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS._Modul_ucheta_sroka_dejjstviya_dogovora.РасчетОстВрем));
                }
            }
        }
    }
