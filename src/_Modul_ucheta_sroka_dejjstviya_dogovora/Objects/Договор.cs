...
namespace IIS._Modul_ucheta_sroka_dejjstviya_dogovora
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Статус fСтатус;
        
        private IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private double fДлительность;
        
        private IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ЕдВремени fЕдВремени;
        
        private IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        
        private IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Клиент fКлиент;
        ...
        public virtual IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ЕдВремени ЕдВремени
        {
            get
            {
                ...
                IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ЕдВремени result = this.fЕдВремени;
        ...
        public virtual IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Статус Статус
        {
            get
            {
                ...
                IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Статус result = this.fСтатус;
        ...
        public virtual IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ТипДоговора Тип
        {
            get
            {
                ...
                IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS._Modul_ucheta_sroka_dejjstviya_dogovora.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Клиент Клиент
        {
            get
            {
                ...
                IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS._Modul_ucheta_sroka_dejjstviya_dogovora.Договор));
                }
            }
        }
    }
